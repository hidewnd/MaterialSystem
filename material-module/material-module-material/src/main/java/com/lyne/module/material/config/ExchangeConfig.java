...
public class ExchangeConfig {
    ...
    public DirectExchange materialExchange() {
        return new DirectExchange(MqConstant.EXCHANGE_MATERIAL);
    }
     ...
     */
    @Bean
    public DirectExchange materialDlExchange() {
        return new DirectExchange(MqConstant.EXCHANGE_DL_MATERIAL);
    }
    ...
    public Queue materialQueue() {
        ...
        // 声明死信交换器
        args.put("x-dead-letter-exchange", MqConstant.EXCHANGE_DL_MATERIAL);
        // 声明死信路由键
        args.put("x-dead-letter-routing-key", MqConstant.KEY_MATERIAL);
        // 声明队列消息过期时间 30分钟
        args.put("x-message-ttl", 30 * 60 * 1000);
        // 队列持久
        return new Queue(MqConstant.QUEUE_MATERIAL_MATERIAL, true, false, false, args);
    }
    ...
    public Queue materialDlQueue() {
        return new Queue(MqConstant.QUEUE_MATERIAL_MATERIAL_DL, true);
    }
    ...
    public Queue materialTypeQueue() {
        ...
        args.put("x-message-ttl", 30 * 60 * 1000);
        return new Queue(MqConstant.QUEUE_MATERIAL_TYPE, true, false, false, args);
    }
    ...
    public Queue materialTypeDlQueue() {
        return new Queue(MqConstant.QUEUE_MATERIAL_TYPE_DL, true);
    }
    ...
    public Queue rackQueue() {
        ...
        args.put("x-message-ttl", 30 * 60 * 1000);
        return new Queue(MqConstant.QUEUE_MATERIAL_RACK, true, false, false, args);
    }
    ...
    public Queue rackDlQueue() {
        return new Queue(MqConstant.QUEUE_MATERIAL_RACK_DL, true);
    }
    ...
    public Queue depotQueue() {
        ...
        args.put("x-message-ttl", 30 * 60 * 1000);
        return new Queue(MqConstant.QUEUE_MATERIAL_DEPOT, true, false, false, args);
    }
    ...
    public Queue depotDlQueue() {
        return new Queue(MqConstant.QUEUE_MATERIAL_DEPOT_DL, true);
    }
    ...
    public Queue registrationQueue() {
        ...
        args.put("x-message-ttl", 30 * 60 * 1000);
        return new Queue(MqConstant.QUEUE_MATERIAL_REGISTRATION, true, false, false, args);
    }
    ...
    public Queue registrationDlQueue() {
        return new Queue(MqConstant.QUEUE_MATERIAL_REGISTRATION_DL, true);
    }
    ...
    public Queue materialRelationQueue() {
        ...
        args.put("x-message-ttl", 30 * 60 * 1000);
        return new Queue(MqConstant.QUEUE_MATERIAL_RELATION_MATERIAL, true, false, false, args);
    }
    ...
    public Queue materialRelationDlQueue() {
        return new Queue(MqConstant.QUEUE_MATERIAL_RELATION_MATERIAL_DL, true);
    }
    ...
    public Queue recordRelationQueue() {
        ...
        args.put("x-message-ttl", 30 * 60 * 1000);
        return new Queue(MqConstant.QUEUE_MATERIAL_RELATION_RECORD, true, false, false, args);
    }
    /**
     * 死信队列
     * 出入库记录绑定处理
    ...
    public Queue recordRelationDlQueue() {
        return new Queue(MqConstant.QUEUE_MATERIAL_RELATION_RECORD_DL, true);
    }
   ...
   // ======================
    ...
    public Binding materialRelationDlBinding() {
        return BindingBuilder
                .bind(materialRelationDlQueue())
                .to(materialDlExchange())
                .with(MqConstant.KEY_MATERIAL_RELATION_MATERIAL);
    }
    ...
    public Binding materialBinding() {
        return BindingBuilder.bind(materialQueue()).to(materialExchange()).with(MqConstant.KEY_MATERIAL);
    }
