	...
	<div class="layout-navbars-breadcrumb-user" :style="{ flex: layoutUserFlexNum }">
		...
		<div class="layout-navbars-breadcrumb-user-icon">
			<el-popover placement="bottom" trigger="click" :width="300">
				<template #reference>
					<el-badge :is-dot="isDotShow">
						<el-icon :title="$t('message.user.title4')">
							<ele-Bell />
						</el-icon>
					</el-badge>
				</template>
				<UserNews @isBot="getIsBotShow" />
			</el-popover>
		</div>
...
export default defineComponent({
	...
	setup() {
		...
		function initUserInfo() {
			const userinfo = <any>store.state.userInfos;
			ResourceSystemApi()
		...
		const getIsBotShow = (isDot: any) => {
			state.isDotShow = isDot;
		};
		return {
			getUserInfos,
			onLayoutSetingClick,
