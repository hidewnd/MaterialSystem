<template>
	<div class="rack-material-enter-operate-container">
		<el-dialog title="入库操作" v-model="isShowDialog" width="769px" draggable>
			<el-row :gutter="24">
...
<style lang="scss">
.rack-material-enter-operate-container {
	.context {
		text-align: center;
		width: 90%;
	}
