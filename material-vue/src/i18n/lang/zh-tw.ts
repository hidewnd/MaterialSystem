...
export default {
	router: {
		...
		systemRole: '角色管理',
		systemMenu: '許可權管理',
		materialResources: '物料資源',
		materialMaterial: '物料管理',
		materialMaterialType: '物料類型管理',
		materialRack: '貨架管理',
		materialDepot: '倉庫管理',
		recordManager: '出入庫管理',
		recordQuery: '記錄查詢',
		...
		outerManger: '出庫管理',
		outerApply: '出庫申請',
		outerMaterialBill: '清單查詢',
		outerProof: '憑證查詢',
		recordApprove: '出入庫審批',
		recordStatistics: '出入庫統計',
		warehouseManger: '倉儲管理',
		depotManger: '倉庫管理',
		depotQuery: '倉庫查詢',
		rackTransfer: '貨架轉移',
		rackManger: '貨架管理',
		rackQuery: '货貨架查詢',
		rackOutOrStored: '物料出入庫',
		inventory: '庫存查詢',
		authority: '許可權管理',
		roleAssignment: '角色分發',
		menuAssignment: '許可權分發',
		restartPassword: '密碼重置',
		visualization: '可視化視圖',
		chartIndex: '可視化圖表',
		visualizingIndex: '可視化大屏',
		visualizingLinkDemo: '數據可視化演示',
		personal: '個人中心',
		workflow: '工作流管理',
